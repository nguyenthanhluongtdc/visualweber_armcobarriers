      ...
      <form id="contact-form" class="form-horizontal form-contact-us" role="form">
        <div class="row">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" placeholder="Phone Number" name="name" value="" required>
              <input type="email" class="form-control" id="email" placeholder="Address" name="email" value="" required>
            </div>
          </div>
        </div>
